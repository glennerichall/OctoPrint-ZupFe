...
URL_EMIT_PRINTER_EVENT = "URL_EMIT_PRINTER_EVENT"
URL_FILE = "URL_FILE"
URL_FILES = "URL_FILES"
...
RPC_REQUEST_PAUSE_PRINT = 59
RPC_REQUEST_POWER_OFF = 47
RPC_REQUEST_POWER_ON = 46
RPC_REQUEST_PRINT_ACTIVE_FILE = 39
RPC_REQUEST_PROGRESS = 45
RPC_REQUEST_READ_TEMPERATURES = 60
RPC_REQUEST_RECEIVE_PROGRESS = 62
RPC_REQUEST_RESUME_PRINT = 58
RPC_REQUEST_SET_ACTIVE_FILE = 41
RPC_REQUEST_START_CAMERA = 65
RPC_REQUEST_STOP_CAMERA = 64
RPC_REQUEST_STOP_PROGRESS = 63
RPC_REQUEST_STOP_TEMPERATURES = 61
RPC_REQUEST_STREAM = 44
RPC_REQUEST_TEMPERATURE_HISTORY = 57
RPC_REQUEST_TOGGLE_POWER = 56
RPC_REQUEST_WEBRTC = 55
RPC_RESPONSE_FAILURE = 67
RPC_RESPONSE_NOOP = 68
RPC_RESPONSE_SUCCESS = 66
...
def get_event_name(value):
    ...
    if value == EVENT_WS_CONNECTION: return "EVENT_WS_CONNECTION"
...
def get_command_name(value):
    ...
    if value == RPC_REQUEST_PAUSE_PRINT: return "RPC_REQUEST_PAUSE_PRINT"
    ...
    if value == RPC_REQUEST_READ_TEMPERATURES: return "RPC_REQUEST_READ_TEMPERATURES"
    if value == RPC_REQUEST_RECEIVE_PROGRESS: return "RPC_REQUEST_RECEIVE_PROGRESS"
    if value == RPC_REQUEST_RESUME_PRINT: return "RPC_REQUEST_RESUME_PRINT"
    if value == RPC_REQUEST_SET_ACTIVE_FILE: return "RPC_REQUEST_SET_ACTIVE_FILE"
    if value == RPC_REQUEST_START_CAMERA: return "RPC_REQUEST_START_CAMERA"
    if value == RPC_REQUEST_STOP_CAMERA: return "RPC_REQUEST_STOP_CAMERA"
    if value == RPC_REQUEST_STOP_PROGRESS: return "RPC_REQUEST_STOP_PROGRESS"
    if value == RPC_REQUEST_STOP_TEMPERATURES: return "RPC_REQUEST_STOP_TEMPERATURES"
    ...
    if value == RPC_RESPONSE_FAILURE: return "RPC_RESPONSE_FAILURE"
    if value == RPC_RESPONSE_NOOP: return "RPC_RESPONSE_NOOP"
    if value == RPC_RESPONSE_SUCCESS: return "RPC_RESPONSE_SUCCESS"
    return "UNKNOWN_VALUE"
